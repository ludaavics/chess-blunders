...
snapshots["test_create_blunder_puzzles[games_loc0] 1"] = [
    {
        "cp_loss": -836.0,
...
snapshots["test_create_blunder_puzzles[games_loc1] 1"] = [
    ...
    {
        "cp_loss": -99812.0,
        "pgn": "18... Nxd4 { [%clk 0:01:53.4] } 19. Nxd4 { [%clk 0:01:46.5] } ( { Refutation (-99999) } 19. Nxd4 Qxg2# ) ( { Solution (-187) } 19. Be4 Nxe2+ ) 19... Qxg2# { [%clk 0:01:53.3] }",
